  ...
  private readonly locationList : Array<Region> = [
    ...
    { 
      ...
      locations: [
        ...
        { id: 4, name: 'Floccesy Ranch' },
        { id: 5, name: 'Virbank City' },
        { id: 6, name: 'Virbank Complex' },
        { id: 7, name: 'Castelia City' },
        { id: 8, name: 'Castelia Sewers' },
        { id: 9, name: 'Relic Passage' },
        { id: 10, name: 'Route 4' },
        { id: 11, name: 'Desert Resort' },
        { id: 12, name: 'Relic Castle' },
        { id: 13, name: 'Route 16' },
        { id: 14, name: 'Lostlorn Forest' },
        { id: 15, name: 'Route 5' },
        { id: 16, name: 'Driftveil Drawbridge' },
        { id: 17, name: 'Driftveil City' },

        { id: 18, name: 'Route 6'},
        { id: 19, name: 'Mistralton Cave'},
        { id: 20, name: 'Chargestone Cave'},
        { id: 21, name: 'Route 7'},
        { id: 22, name: 'Celestial Tower'},
        { id: 23, name: 'Reversal Mountain'},
        { id: 24, name: 'Strange House'},
        { id: 25, name: 'Undella Town'},
        { id: 26, name: 'Undella Bay'},
        { id: 27, name: 'Route 13'},
        { id: 28, name: 'Route 12'},
        { id: 29, name: 'Village Bridge'},
        { id: 30, name: 'Route 11'},
        { id: 31, name: 'Route 9'},
        { id: 32, name: 'Seaside Cave'},
        { id: 33, name: 'Route 21'},
        { id: 34, name: 'Humilau City'},
        { id: 35, name: 'Route 22'},
        { id: 36, name: 'Giant Chasm'},
        { id: 37, name: 'Route 23'},
        { id: 38, name: 'Victory Road'},
        { id: 39, name: 'Marvelous Bridge'},
        { id: 40, name: 'Route 15'},
        { id: 41, name: 'Route 14'},
        { id: 42, name: 'Abundant Shrine'},
        { id: 43, name: 'Moor of Icirrus'},
        { id: 44, name: 'Icirrus City'},
        { id: 45, name: 'Dragonspiral Tower'},
        { id: 46, name: 'Twist Mountain'},
        { id: 47, name: 'Clay Tunne'},
        { id: 48, name: 'Underground Ruins'},
        { id: 49, name: 'Pinwheel Forest'},
        { id: 50, name: 'Nacrene City'},
        { id: 51, name: 'Route 3'},
        { id: 52, name: 'Wellspring Cave'},
        { id: 53, name: 'Striaton City'},
        { id: 54, name: 'Dreamyard'},
        { id: 55, name: 'Route 2'},
        { id: 56, name: 'Accumula Town'},
        { id: 57, name: 'Route 1'},
        { id: 58, name: 'Route 17'},
        { id: 59, name: 'Route 18'},
        { id: 60, name: 'P2 Laboratory'},
